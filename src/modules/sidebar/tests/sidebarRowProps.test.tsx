...
const noop = () => {};
// Stable across calls: a fresh Set per render would change identity on every
// rerender and defeat the memo boundary these tests exist to verify. The real
// controller holds it in useState, which is stable the same way.
const NO_REGENERATING_TITLES: ReadonlySet<string> = new Set<string>();
